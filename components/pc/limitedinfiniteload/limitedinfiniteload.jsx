...
Limitedinfiniteload.defaultProps = {
    ...
    initialLoad: false,
    useWindow: true,
    limitLoader: <p className="bui-limitedinfiniteload-loading">点击加载更多</p>,
    loader: <p className="bui-limitedinfiniteload-loading">加载中...</p>,
    unMoreLoader: <p className="bui-limitedinfiniteload-loading">没有更多了</p>
}
