...
class Signature extends React.Component {
    ...
    componentDidMount () {
   	...
   	render() {
        ...
        let cls = classnames('bui-signature-wrap', className)
     	return (
     		<div className="bui-signature" >
            {this.isCanvasSupported ?
                <div className={cls}>
                    <div className="bui-signature-inner" ref={wrap => (this.wrap = wrap)}>
...
Signature.defaultProps = {
    ...
    strokeStyle: '#000',
    type: 'png',
    unSupportTpl: <p className="bui-signature-unsopport">对不起，当前浏览器不支持Canvas，无法使用本控件！</p>,
    onConfirm: null,
    onCancel: null
};
Signature.propTypes = {
